...
; メッセージウィンドウの設定
[position layer="message0" width="1152" height="218" top="484" left="64"]
...
; 名前枠の設定
[ptext name="chara_name_area" layer="message0" color="&mp.name_color" size="38" x="50" y="500" width="380" align="center"]
